...
(function () {
    ...
    app.controller(controllerId, [
        '$scope', 'message', '$state', '$modal', 'abp.services.app.exam', 'enumConverter', 'user',
        function ($scope, message, $state, $modal, examService, enumConverter, user) {
            var vm = this;
            $scope.tests = [];
            ...
            user.requireRole('User').then(loadTests);
        }
    ]);
})();
